  ...
  return (
    <main className="mt-10 mx-auto max-w-5xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
      <div className="sm:text-center lg:text-left">
        ...
        <p className="mt-3 text-base text-gray-500 sm:mt-4 sm:text-base sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
        ...
        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
          <div className="rounded-md">
            <a
              ...
              className={`w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-background bg-primary hover:bg-primary hover:text-tertiaty md:py-4 md:text-lg md:px-10`}
            >
